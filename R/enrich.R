...
#' @importFrom dplyr %>%
#' @export
enrich <- function(ref, bed_file, frag_size, w_size, s_size, gc_min, gc_max, blast_db, pid, len, blast_hit,tm_min, tm_max, HpTm, HmTm)
